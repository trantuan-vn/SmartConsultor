...
public class ExcelToPostgres {
    ...
    private static void printUsage() {
        System.out.println("Usage: java -jar ExcelToPostgres.jar --path [excelFilePath] --version [version] --dbUrl [dbUrl] --dbUser [dbUser]");
        System.out.println("Example: java -jar ExcelToPostgres.jar --path data.xlsx --version v1 --dbUrl jdbc:postgresql://localhost:5432/db --dbUser user");
    }
